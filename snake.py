...
def move():
    ...
    can.create_oval(Serpent[0][0], Serpent[0][1], Serpent[0][0] + 10, Serpent[0][1] + 10, outline='green',
                    fill='blue')
    test()
    test()
...
def test():
    global pX, pY
    global Serpent
    if Serpent[0][0] > pX - 7 and Serpent[0][0] < pX + 7:
        if Serpent[0][1] > pY - 7 and Serpent[0][1] < pY + 7:
            pX = randrange(5, 495)
            pY = randrange(5, 495)
